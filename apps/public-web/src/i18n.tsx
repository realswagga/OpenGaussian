...
const dictionaries: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'catalog.sort.count': 'Количество точек',
    'catalog.kind.splat': 'Модель',
    'catalog.kind.sceneGroup': 'Группа туров',
    'catalog.kind.organization': 'Организация',
    'catalog.points': 'точек',
    'catalog.published': 'опубликовано',
    'catalog.publishedSplats': 'опубликованных моделей',
    ...
    'catalog.independentTitle': 'Независимые модели',
    'catalog.independentDescription': 'Опубликованные туры без организации.',
    'catalog.noOrgMatches': 'В этой организации нет моделей для текущих фильтров.',
    'catalog.heroKicker': 'Платформа виртуальных туров',
    'catalog.heroCopy': 'Погрузитесь в огромное множество фотореалистичных миров.',
    ...
    'catalog.searchPlaceholder': 'Искать туры или организации',
    'catalog.searchAria': 'Поиск туров и организаций',
    ...
    'org.website': 'Сайт',
    'org.publishedSplats': 'Опубликованные модели',
    'org.scenesFrom': 'Виртуальные туры от {name}.',
    'org.noPreview': 'Нет превью',
    'org.splats': 'точек',
    'org.empty': 'У этой организации пока нет публичных моделей.',
