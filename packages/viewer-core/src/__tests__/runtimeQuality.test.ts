...
describe('PlayCanvasGsplatRuntime quality application', () => {
  ...
  it('places the tracked VR head at the saved camera position with identity orientation', () => {
    const runtime = createRuntime() as unknown as {
    ...
    // Head lands exactly at the saved position
    ...
    // Camera root has identity rotation — headset provides all orientation
